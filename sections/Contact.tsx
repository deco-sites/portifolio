...
export interface Props {
  ...
  export default function ProjectsComponent(props: Props) {
    return (
        <section id="contact" class="grid grid-cols-2 justify-items-center bg-gray-50 pb-10">
            <h1 class="text-gray-900  text-2xl font-extrabold mt-8 text-center col-span-2">
                Contato
            </h1>
            {props.contacts.map((item)=>(
                    <div class="mt-8">
                        <a href={item.link}><img class="mr-auto ml-auto w-24" src={item.icon} alt={item.title}/></a>
